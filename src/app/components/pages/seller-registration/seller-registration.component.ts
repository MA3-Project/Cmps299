...
export class SellerRegistrationComponent implements OnInit {
  ...
  constructor(private cscService: CRCService, private router: Router, private re: RegisterService, private route: Router) { }
  ...
  login() {
    this.router.navigate(["pages/seller-signin"]);
  }
